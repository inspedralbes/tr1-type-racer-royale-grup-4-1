...
.pixel-star:nth-child(9) { top: 5%; left: 50%; animation-delay: 0.1s; }
.pixel-star:nth-child(10) { top: 90%; left: 50%; animation-delay: 0.7s; }
.pixel-star:nth-child(11) { top: 25%; left: 25%; animation-delay: 0.4s; }
.pixel-star:nth-child(12) { top: 75%; right: 25%; animation-delay: 0.2s; }
.pixel-star:nth-child(13) { top: 40%; left: 40%; animation-delay: 0.6s; }
